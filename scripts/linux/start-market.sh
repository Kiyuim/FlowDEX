...
# Fun DEX Market Service Start Script
...
start_service() {
    ...
    nohup go run "$SERVICE_FILE" > "../${LOG_DIR}/market.log" 2>&1 &
    
    # Get the PID
    local pid=$!
    
    # Save PID to file
    echo "$pid" > "../${PID_DIR}/market.pid"
...
main() {
    ...
    if start_service; then
        ...
        print_status "You can check the logs at: ${LOG_DIR}/market.log"
