...
# Fun DEX WebSocket Service Start Script
...
SERVICE_DIR="websocket"
SERVICE_FILE="websocket.go"
SERVICE_PORT="8084"
...
start_service() {
    ...
    nohup go run "$SERVICE_FILE" > "../${LOG_DIR}/websocket.log" 2>&1 &
...
main() {
    ...
    if start_service; then
        ...
        print_status "You can check the logs at: ${LOG_DIR}/websocket.log"
