-- Auto-provisioned core schema (idempotent). Assembled from model/sql/*.sql.
...
CREATE TABLE IF NOT EXISTS `raydium_pool` (
  `id` bigint NOT NULL AUTO_INCREMENT,
 ...
 CREATE TABLE IF NOT EXISTS `cpmm_pool_info`
 (
...
CREATE TABLE IF NOT EXISTS `clmm_pool_info_v1` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
CREATE TABLE IF NOT EXISTS `clmm_pool_info_v2` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `amm_config` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'AMM Pool Configuration',
  `pool_state` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'AMM Pool State Account',
  `input_vault` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Input Token Vault',
...
CREATE TABLE IF NOT EXISTS `sol_token_account` (
  `id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS user_created_assets (
    ...
    user_wallet VARCHAR(255) NOT NULL, asset_type VARCHAR(50) NOT NULL,
    asset_name VARCHAR(255) NOT NULL, asset_symbol VARCHAR(50) NOT NULL,
    asset_address VARCHAR(255) NOT NULL, chain_id BIGINT NOT NULL,
    decimals INT, total_supply VARCHAR(255),
    token0_address VARCHAR(255), token1_address VARCHAR(255),
    token0_symbol VARCHAR(50), token1_symbol VARCHAR(50),
    pool_type VARCHAR(50), fee_tier INT,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    INDEX idx_user_wallet (user_wallet), INDEX idx_chain_id (chain_id),
